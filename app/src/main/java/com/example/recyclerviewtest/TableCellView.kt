...
import com.example.recyclerviewtest.R.styleable
...
class TableCellView @JvmOverloads constructor(
    ...
    init {
        ...
        val attributes = context.obtainStyledAttributes(attrs, styleable.TableCellView)

        val value = attributes.getInt(styleable.TableCellView_border, 0)
